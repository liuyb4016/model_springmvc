...
public class ScaleImage {
	...
	public static void main(String[] s) throws IOException {
		...
		createMiniPic(new File("D:/test/wp/img22.jpg"), 240, 220,  "img2233e.png");
		//ImageUtils.createMiniPic(imgFile, 120, 100, "imgprevs"+endStr);
		
		//ImageUtils.createMiniPic(imgFile, 480, 400, "imgprevl"+endStr);
		//scale2("D:/test/wp/img.jpg", "D:/test/wp/img2.jpg", 100, 120, false);
	}
	
	private static ScaleImage scaleImage=new ScaleImage();
	...
	public static void createMiniPic(File file, int width, int height,String newImgName)
		...
		scaleImage.saveImageAsJpg2(f.getAbsolutePath(),result,width, height);
	}
	
	 // 【无比例】fromFileStr原图片地址,saveToFileStr生成缩略图地址,formatWideth生成图片宽度,formatHeight高度
    public void saveImageAsJpg2(String fromFileStr, String saveToFileStr,
